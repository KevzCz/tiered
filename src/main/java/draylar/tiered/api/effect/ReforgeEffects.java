...
public final class ReforgeEffects {
    ...
    public static boolean run(PlayerEntity player, ItemStack stack, @Nullable List<String> effectIds,
            @Nullable Map<String, Map<String, Float>> effectParams, World world, @Nullable BlockPos pos, ItemStack addition) {
    ...
    public static boolean run(PlayerEntity player, ItemStack stack, @Nullable List<String> effectIds,
            @Nullable Map<String, Map<String, Float>> effectParams, World world, @Nullable BlockPos pos) {
        return run(player, stack, effectIds, effectParams, world, pos, ItemStack.EMPTY);
    }

    public static ReforgeEffect.RollBias preReforge(PlayerEntity player, ItemStack stack,
            @Nullable List<String> effectIds, @Nullable Map<String, Map<String, Float>> effectParams,
            World world, @Nullable BlockPos pos, ItemStack addition) {
