...
public final class CodexEntry {
    ...
    @Nullable
    private final Component relatedHeader;
    ...
    private CodexEntry(String name, int plateFill, @Nullable String description,
            ...
            @Nullable Component relatedHeader, List<WorksWithTag> worksWith, List<AbilityRecipe> recipes) {
        this.name = name;
    ...
    @Nullable public Component relatedHeader() { return relatedHeader; }
    ...
    public static final class Builder {
        ...
        private Component relatedHeader;
        ...
        public Builder relatedHeader(Component header) {
