...
public class ReforgeUtil {
    ...
    public static String getDynamicGroupName(ResourceLocation id, Map<String, Integer> frequencyMap) {
    ...
    public static String formatModifierName(ResourceLocation id) {
    ...
    public static int getColorForModifier(ResourceLocation id) {
        ...
        if (attribute != null && attribute.getStyle() != null && attribute.getStyle().getColor() != null) {
            String color = attribute.getStyle().getColor().serialize();
            if (color!= null) {
    ...
    public static List<ResourceLocation> getAvailableModifiers(ItemStack stack) {
        ...
        for (Map.Entry<ResourceLocation, PotentialAttribute> entry : allAttributes.entrySet()) {
    ...
    public static int getRarityOrder(ResourceLocation id) {
    ...
    public static int getNumericSuffixOrZero(ResourceLocation id) {
        String path = id.getPath();
    ...
    public static boolean matchesEntry(String entry, ItemStack target) {
        ...
        if (entry.startsWith("#")) {
            ...
            return target.is(TagKey.create(BuiltInRegistries.ITEM.key(), tagId));
        }
        return BuiltInRegistries.ITEM.getKey(target.getItem()).toString().equalsIgnoreCase(entry);
    }
